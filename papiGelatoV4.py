...
#Hoofdcode
def ijsje():
    global bolPrijs, hoornPrijs, bakPrijs, aantal, bolTotaalPrijs, hoornOfBak, totaalBolPrijs, totaalHoornPrijs, totaalBakPrijs, hoorntje, bakje, toppingPrijs, topping
    kies = '' ''
