...
def totaal():
    print(f'Uw totaal is: €{totaalBolPrijs + totaalHoornPrijs + totaalBakPrijs}\n')

#Totaal bedrag van de bestelling
def totaal38():
    print(f'Uw totaal is: €{totaalBolPrijs + bakPrijs}\n')

#Totaal betaald bedrag
def totaalPin():
    print(f'Totaal betaald bedrag: €{totaalBolPrijs + totaalHoornPrijs + totaalBakPrijs}\n')
    clearScreen(10)

#Totaal betaald bedrag
def totaalPin38():
    print(f'Totaal betaald bedrag: €{totaalBolPrijs + bakPrijs}\n')
    clearScreen(10)
...
#Hoofdcode
def ijsje():
    global bolPrijs, hoornPrijs, bakPrijs, aantal, bolTotaalPrijs, hoornOfBak, totaalBolPrijs, totaalHoornPrijs, totaalBakPrijs, hoorntje, bakje
    kies = '' ''
